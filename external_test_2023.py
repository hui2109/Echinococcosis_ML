...
def save_results(norm_method: str, dr_method: str, fs_fn_method: str, cls_method: str, ets_auc, fs_results):
    ...
    external_test_set_2023_results['reg_external_test_set_2023'].append(file_name)
    external_test_set_2023_results['AUC'].append(ets_auc)
...
if __name__ == '__main__':
    ...
    external_test_set_2023_results = {
        'reg_external_test_set_2023': [],
        "AUC": []
    }
    save_path = Path('./resources/external_test_results/2023/reg_external_test_set_2023')
    ...
    save_df = pd.DataFrame(external_test_set_2023_results)
    save_df.to_csv(save_path.parent / 'external_test_set_2023_results.csv', index=False)
