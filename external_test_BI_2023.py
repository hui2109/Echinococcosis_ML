...
def norm_training(norm_method: str):
    norm_results = external_test_set_2023.copy()
...
def save_results(norm_method: str, dr_method: str, fs_fn_method: str, cls_method: str, ets_auc, fs_results):
    ...
    external_test_set_2023_results_BI['reg_external_test_set_2023_BI'].append(file_name)
    external_test_set_2023_results_BI['AUC'].append(ets_auc)
...
if __name__ == '__main__':
    ...
    root_results_path = Path(r'G:\FAE\huis_data\results\results2_合并')
    external_test_set_2023: pd.DataFrame = pd.read_pickle('./resources/temp_file/external_test_set_2023.pkl')

    external_test_set_2023_results_BI = {
        'reg_external_test_set_2023_BI': [],
        "AUC": []
    }
    save_path = Path('./resources/external_test_results/2023/reg_external_test_set_2023_BI')
    ...
    save_df = pd.DataFrame(external_test_set_2023_results_BI)
    save_df.to_csv(save_path.parent / 'external_test_set_2023_results_BI.csv', index=False)
