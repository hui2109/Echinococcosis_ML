    ...
    if legend:
        ...
        ax.legend(
            [roc_curves[0], roc_curves[1], roc_curves[2], roc_curves[3],
             ...
             baseline],
            [auc_labels[0], auc_labels[1], auc_labels[2], auc_labels[3], f'{italic_P} = .007', f'{italic_P} < .001', f'{italic_P} < .001', '基准线'],
            loc='upper left',
...
if __name__ == '__main__':
    ...
    indices = ['DL_val', 'efficientNet_val', 'inception_val', 'ResNet_val']
    results_path_all = {
    ...
    add_zoom_axes(ax, (0.12, 0.75), (0.2, 0.83))

    plt.savefig('./saved_figs/Val_VGG_VS_Others_Zoom_zh.tiff', bbox_inches='tight')
    # plt.show()
