...
if __name__ == '__main__':
    ...
    # 训练集、交叉验证集及独立测试集
    source_1 = open_specific_path('Mean', 'PCC', 'ANOVA_32', 'RF')
    source_2 = open_specific_path('Mean', 'PCC', 'KW_32', 'RF')
    source_3 = open_specific_path('Mean', 'PCC', 'RFE_32', 'RF')
    source_4 = open_specific_path('Mean', 'PCC', 'Relief_32', 'RF')
    data_1 = {
        '训练集': (
            source_1['train_AUC'], source_2['train_AUC'], source_3['train_AUC'], source_4['train_AUC']),
        '交叉验证集': (
        ...
        '测试集': (source_1['testing'], source_2['testing'], source_3['testing'], source_4['testing'])
    }
    species = ['ANOVA', 'KW', 'RFE', 'Relief' + sample]
    ...
    plt.savefig('./saved_figs/Figure 3.tiff', bbox_inches='tight')
    plt.show()
