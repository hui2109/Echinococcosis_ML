    ...
    if legend:
        ...
        ax.legend(
            [roc_curves[0], roc_curves[1], roc_curves[2],
             ...
             baseline],
            [auc_labels[0], auc_labels[1], auc_labels[2], f'{italic_P} = .380', f'{italic_P} < .001', '基准线'],
            loc='upper left',
...
if __name__ == '__main__':
    ...
    indices = ['ML_AE_inves', 'External_senior_E', 'External_senior_NE']
    results_path_all = {
    ...
    add_zoom_axes(ax, (0.1, 0.73), (0.29, 0.92))

    plt.savefig('./saved_figs/ML_AE_VS_Inves_Zoom_zh.tiff', bbox_inches='tight')
    # plt.show()
