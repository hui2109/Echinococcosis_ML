    ...
    if legend:
        ...
        ax.legend(
            [roc_curves[0], roc_curves[1], roc_curves[2], roc_curves[3], roc_curves[4], roc_curves[5],
             ...
             baseline],
            [auc_labels[0], auc_labels[1], auc_labels[2], auc_labels[3], auc_labels[4], auc_labels[5], f'All {italic_P} >= ' + r'$\frac{0.05}{15}$' + ' (Bonferroni Rectify)',
             '基准线'],
            loc='upper left',
...
if __name__ == '__main__':
    ...
    indices = ['outline_SVM_p1', 'outline_SVM_p2', 'outline_SVM_p3', 'outline_SVM_p4', 'outline_SVM_p5',
               'outline_SVM_p6']
    results_path_all = {
    ...
    add_zoom_axes(ax, (0.17, 0.6), (0.27, 0.73))

    plt.savefig('./saved_figs/Outline_SVM_zh.tiff', bbox_inches='tight')
    # plt.show()
